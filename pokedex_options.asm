...
USE_GEN3_STYLE_TYPE_GFX EQU TRUE
...
USING_INCREASED_SPRITE_ANIMATION EQU FALSE
	...
	; Swap Dark and Ghost?
SWAP_DARK_GHOST_TYPES EQU FALSE
...
USE_COMPRESSED_POKEDEX_GFX EQU FALSE
