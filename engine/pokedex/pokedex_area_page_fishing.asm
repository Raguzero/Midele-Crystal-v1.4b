...
.prep_loop
	...
	sra a
	sra a
	cp 13 ; + 1     ; cp NUM_FISHGROUPS DA ERROR AL COMPILAR, HAY 13 GRUPOS DE FISH WILD
	jr z, .reached_end
	;;;;;;;;;;;;;;;;;;;;;
...
.mainloop
	...
	ld bc, 7  ; FISHGROUP_DATA_LENGTH DA ERROR AL COMPILAR, EL LENGHT ES 7
	add hl, bc ; FishGroups + FISHGROUP_DATA_LENGTH * n
	pop bc ; FISH GROUP #
	inc c ; FISH GROUP #

	ld a, 13      ; cp NUM_FISHGROUPS DA ERROR AL COMPILAR, HAY 13 GRUPOS DE FISH WILD
	cp c
	ret z ; not found
	jr .mainloop
.found
...
; Multiply hMultiplicand (3 bytes) by hMultiplier. Result in hProduct.
	ld a, 7   ; FISHGROUP_DATA_LENGTH DA ERROR AL COMPILAR, EL LENGHT ES 7
	ldh [hMultiplier], a
