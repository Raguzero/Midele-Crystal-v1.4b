...
; ???
	const EVENT_105 ; MEWTWO CLONE
	const EVENT_106 ; TOPO
	const EVENT_107 ; AVADER
	const EVENT_108 ; LAVNDER
	const EVENT_109 ; PHENT
	const EVENT_10A ; PACOBEER 2
	const EVENT_10B ; SANTYAGO2
	const EVENT_10C ; MUSIC PLAYER
	const EVENT_10D ; SACRED ASH
	const EVENT_10E ; FURRY 2
	const EVENT_10F ; ZZZ4
	const EVENT_110 ; MICOLO FINAL
	const EVENT_111 ; CATERMANO NO CONSEGUIDO
	const EVENT_112 ; CATERMANO CONSEGUIDO
	const EVENT_113 ; GUARDIA GUARDERIA
	const EVENT_114 ; PKHEX
	const EVENT_115 ; MEWTWO CLONE GUARDIA
	const EVENT_116 ; PP UP 99
	const EVENT_117
	const EVENT_118
	const EVENT_119
	const EVENT_11A
...
; Officer
	...
	const EVENT_BEAT_OFFICER_TSURUKO
	const EVENT_BEAT_OFFICER_ALLIARE
	const EVENT_BEAT_OFFICER_MELKOR
	const EVENT_BEAT_OFFICER_FURRY
; CooltrainerM
...
; ???  --> HGSS TRAINERS
	...
	const EVENT_BEAT_CAMPER_VIRGIL
	...
	const EVENT_BEAT_COOLTRAINERM_ARABELLA
	...
	const EVENT_BEAT_POKEFANM_BOONE
...
; New to Crystal
	...
	const EVENT_BEAT_RAGU
	const EVENT_BEAT_PACOCHEF
	const EVENT_BEAT_GOLDY
	const EVENT_BEAT_SPOLKER
	const EVENT_BEAT_SHELEA
	const EVENT_BEAT_EXI
	const EVENT_BEAT_AVADER
	const EVENT_BEAT_SANTYAGO
	const EVENT_BEAT_MERUM
	const EVENT_BEAT_LAVENDER
	const EVENT_BEAT_GRIM
	const EVENT_BEAT_TRAINER
	const EVENT_BEAT_TRAINER2
	const EVENT_BEAT_TRAINER3
	const EVENT_BEAT_TRAINER4
	const EVENT_BEAT_TRAINER5
	const EVENT_BEAT_TRAINER6
	const EVENT_BEAT_TRAINER7
	const EVENT_BEAT_TRAINER8
	const EVENT_BEAT_TRAINER9
	const EVENT_BROCK_REMATCH
	const EVENT_MISTY_REMATCH
	const EVENT_LTSURGE_REMATCH
	...
	const EVENT_SUICUNE
	const EVENT_BEAT_ULTRAMAGIC
	const EVENT_BEAT_ZZZ
	const EVENT_BEAT_ZZZ2
	const EVENT_BEAT_ZZZ3
	const EVENT_BEAT_MICOLO
	const EVENT_BEAT_HUEVO
	const EVENT_AVADER_DESAPARECER
	const EVENT_GOT_PLAYERS_HOUSE_POKEBALL
	const EVENT_GOT_PLAYERS_HOUSE_POKEBALL2
	const EVENT_PLAYERS_HOUSE_POKEBALL
	const EVENT_PLAYERS_HOUSE_POKEBALL2
	const EVENT_DISAPPEAR_MICOLO
	const EVENT_ULTRAMAGIC_DESAPARECER
	const EVENT_OFFICER_TSURUKO_DAY
	const EVENT_OFFICER_TSURUKO_NIGHT
	const EVENT_OFFICER_ALLIARE_DAY
	const EVENT_OFFICER_ALLIARE_NIGHT
	const EVENT_OFFICER_MELKOR_DAY
	const EVENT_OFFICER_MELKOR_NIGHT
	const EVENT_OFFICER_FURRY_DAY
	const EVENT_OFFICER_FURRY_NIGHT
	const EVENT_12 ; DENYS
	const EVENT_13 ; KAISSER
	const EVENT_14 ; JZOMBIE
	const EVENT_15 ; MICOLO
	const EVENT_16 ; RAZANDLAV
	const EVENT_17 ; USADO LUCKY EGG
	const EVENT_18 ; AVADER APARECE EN SILVER CAVE
	const EVENT_19 ; AVADER VENCIDO EN SILVER CAVE
	const EVENT_20 ; NO ESTÁ EN USO
	const EVENT_21 ; NO ESTÁ EN USO
