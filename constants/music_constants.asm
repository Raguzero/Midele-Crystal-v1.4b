...
NUM_ORIGINAL_MUSIC EQU const_value

	const MUSIC_FINALBATTLE
	const MUSIC_NGE_INTRO ; A Cruel Angel's Thesis (EVANGELION)
	const MUSIC_ELITEFOURUNOVA
	const MUSIC_WALLYBATTLE
	const MUSIC_LOOKZINNIA
	const MUSIC_CHAMPIONBATTLEDPPT
	const MUSIC_CIPHERPEONBATTLE
	const MUSIC_RIVALBATTLE_XY
	const MUSIC_CHAMPIONBATTLE_B2W2
	const MUSIC_LASTPOKEMON
	const MUSIC_SANTALUNE
	const MUSIC_MAXIEARCHIEBATTLE
	const MUSIC_ALOLAELITEFOURBATTLE
	const MUSIC_HEARTMULHOLLAND
	const MUSIC_EVERGRANDECITY
	const MUSIC_XYLEGENDBATTLE
