...
;BASE_UNKNOWN_1   EQUS "(wBaseUnknown1 - wCurBaseData)"  ; Delete to save space
BASE_EGG_STEPS   EQUS "(wBaseEggSteps - wCurBaseData)"
;BASE_UNKNOWN_2   EQUS "(wBaseUnknown2 - wCurBaseData)"  ; Delete to save space
BASE_PIC_SIZE    EQUS "(wBasePicSize - wCurBaseData)"
;BASE_PADDING     EQUS "(wBasePadding - wCurBaseData)"  ; Delete to save space
