	...
	const INDIGOPLATEAUPOKECENTER1F_REMINDER
...
IndigoPlateauPokecenter1F_MapEvents:
	...
	object_event 10,  7, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MoveReminderScriptIndigo, -1
