...
EXPORT GOLDENRODGAMECORNERPRIZEROOM_CHIKORITA_COINS 
EXPORT GOLDENRODGAMECORNERPRIZEROOM_CYNDAQUIL_COINS 
EXPORT GOLDENRODGAMECORNERPRIZEROOM_TOTODILE_COINS 
