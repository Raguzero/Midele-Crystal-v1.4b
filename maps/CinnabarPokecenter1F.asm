	...
	const CINNABARPOKECENTER1F_REMINDER
...
CinnabarPokecenter1F_MapEvents:
	...
	object_event  6,  1, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MoveReminderScriptCinnabar, -1
