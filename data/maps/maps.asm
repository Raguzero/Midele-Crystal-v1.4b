...
MapGroup_Dungeons:
	...
	map MicoloHideout, TILESET_FACILITY, DUNGEON, MICOLO_HIDEOUT, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MicoloHideoutBasement, TILESET_FACILITY, DUNGEON, MICOLO_HIDEOUT, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
