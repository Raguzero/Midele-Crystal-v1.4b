...
MonMenuIconPals:
	...
	icon_pals BROWN, GREEN ; MACHOKE
	icon_pals BROWN, GREEN ; MACHAMP
	...
	icon_pals RED, PINK ; HO_OH
	icon_pals GREEN, PINK ; CELEBI
	icon_pals RED, BLUE       ; NOROWARA
	icon_pals RED, GRAY     ; BOMBSEEKER
